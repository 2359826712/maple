...
const assertions = [
  ...
  [index.includes('<link rel="canonical" href="https://mpstorys.com/"'), 'index.html homepage canonical URL is not the bare production domain'],
  [index.includes('<meta property="og:url" content="https://mpstorys.com/"'), 'index.html homepage Open Graph URL is not the bare production domain'],
  [!index.includes('https://mpstorys.com/en/GMS'), 'index.html still references the legacy /en/GMS homepage URL'],
