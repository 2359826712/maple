...
try {
  ...
  const verification = await client.query(`
    select
      ...
      to_regclass('public.localization_memory') is not null as localization_memory,
      to_regclass('public.localization_resolutions') is not null as localization_resolutions,
