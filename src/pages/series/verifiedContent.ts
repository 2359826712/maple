...
const editorialSeriesContent: Record<string, SeriesContent> = {
  'maplestory-pc': {
    ...
    maps: [officialIndex('MapleStory Game Guide maps and systems', 'Official game information for the main PC game, used alongside the MPStorys training map and boss reset workspace.', 'Nexon MapleStory', 'https://www.nexon.com/maplestory/game')],
  ...
  'maplestory-classic': {
    ...
    maps: [officialIndex('Classic World test scope', 'Use the official test page for currently verified Classic World access, platform, and content-scope information before planning map coverage.', 'Nexon Classic World', 'https://www.nexon.com/mscw/classic-world-closed-online-test-2')],
  ...
  'maplestory-m': {
    ...
    maps: [{ title: 'Maple Guide hunting-ground reference', description: 'Official MapleStory M guide material for level-based hunting grounds, recommended content, filters, and rewards.', sourceLabel: 'MapleStory M Game Guide', sourceUrl: 'https://forum.nexon.com/MapleStoryMGlobal/board_view?board=2696&thread=2008054', publishedAt: '2023-02-06' }],
  ...
  'maplestory-n': {
    ...
    maps: [officialIndex('MapleStory N launch guide routes', 'Official launch documentation for the in-game guide, rankings, marketplace, probability info, and service entry points.', 'MapleStory N Documentation', 'https://docs.maplestoryn.io/welcome-to-maplestory-n/maplestory-n-official-launch')],
  ...
  'maplestory-worlds': {
    ...
    maps: [officialIndex('MapleStory Worlds discovery and creator maps', 'Official platform and Creator Center references for worlds, creator workflows, performance checks, and published map experiences.', 'MapleStory Worlds Creator Center', 'https://maplestoryworlds-creators.nexon.com/en')],
  ...
  'maplestory-idle': {
    ...
    maps: [{ title: 'Hero\'s Journey chapter and field planning', description: 'Use the official patch-note archive to verify chapter, Party Quest, artifact, companion, and seasonal field changes.', sourceLabel: 'MapleStory: Idle RPG Forum', sourceUrl: 'https://forum.nexon.com/maplestoryidle/board_view?board=6675&thread=3474001', publishedAt: '2026-06-11' }],
