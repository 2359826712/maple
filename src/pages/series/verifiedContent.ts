...
const editorialSeriesContent: Record<string, SeriesContent> = {
  ...
  'maplestory-m': {
    ...
    rankings: [{ title: 'In-game Rank menu', description: 'The official Basic UI guide documents overall, friend, guild, and character rank views in the MapleStory M client.', sourceLabel: 'MapleStory M Game Guide', sourceUrl: 'https://forum.nexon.com/MapleStoryMGlobal/board_view?board=2696&thread=2007960', publishedAt: '2023-02-06' }],
  ...
  'maplestory-n': {
    ...
    rankings: [officialIndex('MapleStory N Ranking', 'The official launch guide confirms rankings across multiple categories in MapleStory N Web.', 'MapleStory N Documentation', 'https://docs.maplestoryn.io/welcome-to-maplestory-n/maplestory-n-official-launch')],
  ...
  'maplestory-worlds': {
    ...
    rankings: [{ title: 'Artale (Global)', description: 'The official world page displays live public metrics including total players, favorites, platform support, and last-updated date.', sourceLabel: 'MapleStory Worlds', sourceUrl: 'https://maplestoryworlds.nexon.com/en/play/79ff3d4d4aba4796baa484e411754533/' }],
