...
const bossDefinitions: BossDefinition[] = [
  // ── Zakum ──────────────────────────────────────────────
  {
    ...
    mesoReward: 2500000,
    expReward: 2400000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/7/72/Boss_Entry_UI_-_Zakum.png/revision/latest?cb=20231215174133',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Zakum Helmet', rarity: 'Rare', description: 'Iconic helmet with strong defensive stats and a boss damage bonus.' },
      { name: 'Zakum Jewel', rarity: 'Epic', description: 'Rare crafting material used in high-level equipment recipes.' },
      { name: 'Advanced Pendant of the Spirit', rarity: 'Epic', description: 'Upgradable pendant that grants bonus EXP and drop rate.' },
      { name: 'Chaos Zakum Scroll', rarity: 'Legendary', description: 'Chaos scroll that randomly adds stats to equipment.' },
    ],
    phases: [
      {
        name: 'Arms Phase',
  ...
  // ── Horntail ───────────────────────────────────────────
  {
    ...
    mesoReward: 4000000,
    expReward: 4200000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/9/91/Boss_Entry_UI_-_Horntail.png/revision/latest?cb=20231215174201',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Horntail Necklace', rarity: 'Rare', description: 'Accessory with all-stat bonuses and boss damage.' },
      { name: 'Horntail Ring', rarity: 'Epic', description: 'Powerful ring with weapon attack and magic attack.' },
      { name: 'Chaos Horntail Pendant', rarity: 'Legendary', description: 'High-tier pendant granting substantial stat boosts.' },
      { name: 'Dragon Stone', rarity: 'Rare', description: 'Material used for crafting dragon equipment.' },
    ],
    phases: [
      {
        name: 'Parts Phase',
  ...
  // ── Pink Bean ──────────────────────────────────────────
  {
    ...
    mesoReward: 6000000,
    expReward: 5400000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/7/79/Boss_Entry_UI_-_Pink_Bean.png/revision/latest?cb=20231215174219',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Pink Bean Hat', rarity: 'Epic', description: 'Cosmetic hat with decent stat bonuses.' },
      { name: 'Pink Bean Cushion', rarity: 'Rare', description: 'Chair item that provides HP/MP regeneration.' },
      { name: 'Papulatus Mark', rarity: 'Epic', description: 'Crafting material for high-level accessories.' },
      { name: 'Chaos Scroll of Goodness', rarity: 'Legendary', description: 'Scroll that adds random positive stats to equipment.' },
    ],
    phases: [
      {
        name: 'Statue Phase',
  ...
  // ── Papulatus ──────────────────────────────────────────
  {
    ...
    mesoReward: 7000000,
    expReward: 6000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/8/83/Boss_Entry_UI_-_Papulatus.png/revision/latest?cb=20231215174215',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Papulatus Mark', rarity: 'Epic', description: 'Key material for crafting the Papulatus pendant.' },
      { name: 'Cracked Dimensional Door', rarity: 'Rare', description: 'Material used for high-level crafting and upgrades.' },
      { name: 'Time Fragment', rarity: 'Epic', description: 'Rare crafting component from the Temple of Time.' },
      { name: 'Chaos Papulatus Pendant', rarity: 'Legendary', description: 'Top-tier pendant with all-stat and boss damage bonuses.' },
    ],
    phases: [
      {
  ...
  // ── Magnus ─────────────────────────────────────────────
  {
    ...
    mesoReward: 10000000,
    expReward: 8400000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/6/6f/Boss_Entry_UI_-_Magnus.png/revision/latest?cb=20231215174211',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Tyrant Helmet', rarity: 'Legendary', description: 'Part of the Tyrant set with powerful boss damage stats.' },
      { name: 'Tyrant Cape', rarity: 'Legendary', description: 'Part of the Tyrant set granting attack power and stats.' },
      { name: 'Tyrant Pendant', rarity: 'Legendary', description: 'Part of the Tyrant set with all-stat bonuses.' },
      { name: 'Tyrant Belt', rarity: 'Legendary', description: 'Part of the Tyrant set with HP and defense bonuses.' },
    ],
    phases: [
      {
        name: 'Ground Phase',
  ...
  // ── Hilla ──────────────────────────────────────────────
  {
    ...
    mesoReward: 5000000,
    expReward: 4800000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/a/a6/Boss_Entry_UI_-_Hilla.png/revision/latest?cb=20231215174158',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Hilla\'s Soul Ring', rarity: 'Epic', description: 'Ring that grants a temporary power boost skill.' },
      { name: 'Necrobatic Staff', rarity: 'Epic', description: 'Staff with magic attack and intelligence bonuses.' },
      { name: 'Dark Flame', rarity: 'Rare', description: 'Material used for enhancing dark magic equipment.' },
      { name: 'Hilla\'s Feather', rarity: 'Rare', description: 'Decorative feather item with minor stat bonuses.' },
    ],
    phases: [
      {
        name: 'Witch Phase',
  ...
  // ── Cygnus ─────────────────────────────────────────────
  {
    ...
    mesoReward: 12000000,
    expReward: 10000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/9/9d/Boss_Entry_UI_-_Cygnus.png/revision/latest?cb=20231215174148',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Cygnus Emblem', rarity: 'Epic', description: 'Emblem accessory with boss damage and attack stats.' },
      { name: 'Empress\'s Blessing', rarity: 'Legendary', description: 'Rare item that provides a permanent stat boost.' },
      { name: 'Royal Seal', rarity: 'Epic', description: 'Crafting material for Cygnus-tier equipment upgrades.' },
      { name: 'Empress\'s Feather', rarity: 'Rare', description: 'Decorative item from the Cygnus Knights storyline.' },
    ],
    phases: [
      {
        name: 'Empress Phase',
  ...
  // ── Lotus ──────────────────────────────────────────────
  {
    ...
    mesoReward: 20000000,
    expReward: 15000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/5/53/Boss_Entry_UI_-_Lotus.png/revision/latest?cb=20231215174207',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Sweetwater Tattoo', rarity: 'Legendary', description: 'High-tier accessory with boss damage and critical rate.' },
      { name: 'Sweetwater Earring', rarity: 'Legendary', description: 'Earring with all-stat bonuses and ignore defense.' },
      { name: 'Lotus Coin', rarity: 'Rare', description: 'Currency used to purchase Sweetwater equipment.' },
      { name: 'Reboot Power Crystal', rarity: 'Epic', description: 'Material for upgrading end-game equipment.' },
    ],
    phases: [
      {
        name: 'Lotus Phase 1',
  ...
  // ── Damien ─────────────────────────────────────────────
  {
    ...
    mesoReward: 22000000,
    expReward: 16000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/e/e8/Boss_Entry_UI_-_Damien.png/revision/latest?cb=20231215174150',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Damien Weapon (Dragon Saber)', rarity: 'Legendary', description: 'Powerful weapon with boss damage and attack bonuses.' },
      { name: 'Fafnir Weapon', rarity: 'Legendary', description: 'Top-tier weapon craftable from Damien materials.' },
      { name: 'Dragon Crystal', rarity: 'Epic', description: 'Material used for upgrading Fafnir equipment.' },
      { name: 'Damien\'s Horn', rarity: 'Rare', description: 'Trophy item with minor stat bonuses.' },
    ],
    phases: [
      {
        name: 'Damien Phase',
  ...
  // ── Lucid ──────────────────────────────────────────────
  {
    ...
    mesoReward: 25000000,
    expReward: 18000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/b/b2/Boss_Entry_UI_-_Lucid.png/revision/latest?cb=20231215174209',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Arcane Umbra Weapon', rarity: 'Legendary', description: 'End-game weapon from the Arcane Umbra set.' },
      { name: 'Lucid\'s Dream Fragment', rarity: 'Epic', description: 'Material for crafting Arcane Umbra equipment.' },
      { name: 'Dream Crystal', rarity: 'Rare', description: 'Currency used to purchase Arcane Umbra gear.' },
      { name: 'Nightmare Shard', rarity: 'Epic', description: 'Rare material for upgrading high-tier accessories.' },
    ],
    phases: [
      {
  ...
  // ── Will ───────────────────────────────────────────────
  {
    ...
    mesoReward: 28000000,
    expReward: 20000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/4/44/Boss_Entry_UI_-_Will.png/revision/latest?cb=20231215174131',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Arcane Umbra Armor', rarity: 'Legendary', description: 'End-game armor piece from the Arcane Umbra set.' },
      { name: 'Will\'s Web Fragment', rarity: 'Epic', description: 'Material used in Arcane Umbra armor crafting.' },
      { name: 'Spider Silk Thread', rarity: 'Rare', description: 'Crafting material for high-level equipment upgrades.' },
      { name: 'Corrupted Essence', rarity: 'Epic', description: 'Rare drop used for starforce enhancement materials.' },
    ],
    phases: [
      {
        name: 'Spider Phase',
  ...
  // ── Gloom ──────────────────────────────────────────────
  {
    ...
    mesoReward: 30000000,
    expReward: 22000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/1/1f/Boss_Entry_UI_-_Giant_Monster_Gloom.png/revision/latest?cb=20231215174152',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Arcane Umbra Shoulder', rarity: 'Legendary', description: 'End-game shoulder piece from the Arcane Umbra set.' },
      { name: 'Gloom\'s Dark Core', rarity: 'Epic', description: 'Material for crafting Arcane Umbra shoulder accessories.' },
      { name: 'Shadow Fragment', rarity: 'Rare', description: 'Crafting material for shadow-based equipment.' },
      { name: 'Abyssal Stone', rarity: 'Epic', description: 'Rare material used for enhancing Arcane Umbra gear.' },
    ],
    phases: [
      {
        name: 'Shadow Phase',
  ...
  // ── Darknell ───────────────────────────────────────────
  {
    ...
    mesoReward: 32000000,
    expReward: 24000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/6/64/Boss_Entry_UI_-_Guard_Captain_Darknell.png/revision/latest?cb=20231215174154',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Arcane Umbra Hat', rarity: 'Legendary', description: 'End-game hat from the Arcane Umbra set.' },
      { name: 'Darknell\'s Flame', rarity: 'Epic', description: 'Material for crafting the Arcane Umbra hat.' },
      { name: 'Hellfire Shard', rarity: 'Rare', description: 'Crafting material for fire-based equipment.' },
      { name: 'Demon\'s Heart', rarity: 'Epic', description: 'Rare material for upgrading high-tier equipment.' },
    ],
    phases: [
      {
        name: 'Sword Phase',
  ...
  // ── Verus Hilla ────────────────────────────────────────
  {
    ...
    mesoReward: 40000000,
    expReward: 30000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/c/c2/Boss_Entry_UI_-_Verus_Hilla.png/revision/latest?cb=20231215174223',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Weapon', rarity: 'Legendary', description: 'End-game weapon from the Genesis set, superior to Arcane Umbra.' },
      { name: 'Verus Hilla\'s Soul', rarity: 'Legendary', description: 'Key material for crafting Genesis equipment.' },
      { name: 'Genesis Weapon Box', rarity: 'Legendary', description: 'Box containing a random Genesis weapon.' },
      { name: 'Origin of Creation', rarity: 'Epic', description: 'Rare crafting material for Genesis-tier upgrades.' },
    ],
    phases: [
      {
        name: 'Hilla Phase',
  ...
  // ── Black Mage ─────────────────────────────────────────
  {
    ...
    mesoReward: 60000000,
    expReward: 50000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/2/2a/Boss_Entry_UI_-_Black_Mage.png/revision/latest?cb=20231215174141',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Absolute Lab Equipment', rarity: 'Legendary', description: 'Top-tier end-game equipment set from the Black Mage.' },
      { name: 'Black Mage\'s Essence', rarity: 'Legendary', description: 'Ultra-rare material for the most powerful crafting recipes.' },
      { name: 'Genesis Armor Piece', rarity: 'Legendary', description: 'End-game armor from the Genesis set.' },
      { name: 'Command Force Stone', rarity: 'Legendary', description: 'Material for upgrading Absolute Lab equipment.' },
    ],
    phases: [
      {
  ...
  // ── Kalos ──────────────────────────────────────────────
  {
    ...
    mesoReward: 42000000,
    expReward: 32000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/4/45/Mob_Kalos_the_Guardian.png/revision/latest?cb=20220217092540',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Armor Material', rarity: 'Legendary', description: 'Material used to craft Genesis armor pieces.' },
      { name: 'Kalos\'s Scale', rarity: 'Epic', description: 'Rare crafting material from the dragon Kalos.' },
      { name: 'Dragon Heart', rarity: 'Legendary', description: 'Core material for the highest-tier equipment upgrades.' },
      { name: 'Eternal Flame', rarity: 'Rare', description: 'Material for enhancing fire-element equipment.' },
    ],
    phases: [
      {
        name: 'Dragon Phase',
  ...
  // ── Limbo ──────────────────────────────────────────────
  {
    ...
    mesoReward: 44000000,
    expReward: 34000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/9/98/Mob_Limbo.png/revision/latest?cb=20230803094118',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Accessory', rarity: 'Legendary', description: 'End-game accessory from the Genesis set.' },
      { name: 'Limbo\'s Void Shard', rarity: 'Epic', description: 'Rare material from the void dimension.' },
      { name: 'Dimensional Fragment', rarity: 'Legendary', description: 'Key material for crafting Genesis accessories.' },
      { name: 'Void Essence', rarity: 'Epic', description: 'Material for upgrading void-tier equipment.' },
    ],
    phases: [
      {
        name: 'Void Phase',
  ...
  // ── Seren ──────────────────────────────────────────────
  {
    ...
    mesoReward: 42000000,
    expReward: 32000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/d/dd/NPCArtwork_Seren_%281%29.png/revision/latest?cb=20191119094901',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Belt', rarity: 'Legendary', description: 'End-game belt from the Genesis set.' },
      { name: 'Seren\'s Radiance', rarity: 'Epic', description: 'Material for crafting the Genesis belt.' },
      { name: 'Holy Light Shard', rarity: 'Rare', description: 'Crafting material for light-element equipment.' },
      { name: 'Celestial Fragment', rarity: 'Epic', description: 'Rare material for high-tier equipment upgrades.' },
    ],
    phases: [
      {
        name: 'Guardian Phase',
  ...
  // ── Baldrix ────────────────────────────────────────────
  {
    ...
    mesoReward: 44000000,
    expReward: 34000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/4/4e/Black_Mage.png/revision/latest?cb=20110106122120',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Shoulder', rarity: 'Legendary', description: 'End-game shoulder accessory from the Genesis set.' },
      { name: 'Baldrix\'s Horn', rarity: 'Epic', description: 'Rare crafting material from the demon Baldrix.' },
      { name: 'Infernal Core', rarity: 'Legendary', description: 'Key material for crafting Genesis shoulder gear.' },
      { name: 'Demon Blood', rarity: 'Rare', description: 'Material for enhancing demon-tier equipment.' },
    ],
    phases: [
      {
        name: 'Warrior Phase',
  ...
  // ── Slime ──────────────────────────────────────────────
  {
    ...
    mesoReward: 42000000,
    expReward: 32000000,
    image: 'https://static.wikia.nocookie.net/maplestory/images/a/ac/Mob_Ancient_King_Slime.png/revision/latest?cb=20210902190816',
    dataSource: 'GMS Interactive',
    lastVerified: '2026-07-10',
    drops: [
      { name: 'Genesis Shoes', rarity: 'Legendary', description: 'End-game shoes from the Genesis set.' },
      { name: 'Slime\'s Core', rarity: 'Epic', description: 'Rare material from the giant slime boss.' },
      { name: 'Viscous Fragment', rarity: 'Legendary', description: 'Key material for crafting Genesis shoes.' },
      { name: 'Primal Slime Extract', rarity: 'Rare', description: 'Material for upgrading end-game potions and consumables.' },
    ],
    phases: [
      {
...
const officialBossGuideUrl = 'https://gi.maplestory.nexon.com/Guide/GameInformation/Boss/ProcessBossContent';
...
export const bosses: BossInfo[] = bossDefinitions.map((boss) => ({
  ...
  phases: [],
  tips: [],
  dataSource: 'Planning only · detailed rewards and mechanics withheld pending verification',
