...
const CommunityPage = lazyWithPreload(() => import("../pages/community/page"));
...
const routePrefetchers: Array<[string, { preload: () => Promise<unknown> }]> = [
  ...
  ["/updates", preloadSeriesModuleRoute(NewsPage)],
  ...
  ["/community", preloadSeriesModuleRoute(CommunityPage)],
  ...
  ["/tools", preloadSeriesModuleRoute(MaplerHouse)],
